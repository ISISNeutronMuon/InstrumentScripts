...
_surf = SurfDefaultScan()
scan = local_wrapper(_surf, "scan")
ascan = local_wrapper(_surf, "ascan")
dscan = local_wrapper(_surf, "dscan")
rscan = local_wrapper(_surf, "rscan")
populate = local_wrapper(_surf, "populate")
last_scan = local_wrapper(_surf, "last_scan")
