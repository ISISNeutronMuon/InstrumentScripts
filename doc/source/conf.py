...
project = u'GENIE Python Scripts'
copyright = u'2018, ISIS Computing group'
...
man_pages = [
    ('index', 'geniepythonscripts', u'GENIE Python Scripts',
...
texinfo_documents = [
  ('index', 'geniepythonscripts', u'GENIE Python Scripts',
   u'ISIS Computing Group', 'GENIE Python Scripts', 'Scripts for instruments at the ISIS Neutron and Muon source',
   'Miscellaneous'),
]
